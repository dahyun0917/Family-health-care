...
//        await fetchFields(token: token)
//        await fetchPromise(token: token)
//        await fetchMedicine(token: token)
//    }
//
//    func fetchFields(token:String)async{
...
//    }
//
//    func fetchPromise(token:String)async{
//        let db = Firestore.firestore()
...
//    }
//
//    func fetchMedicine(token:String)async{
//        let db = Firestore.firestore()
